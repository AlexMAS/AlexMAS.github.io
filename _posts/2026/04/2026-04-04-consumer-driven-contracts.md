...
Я давно заинтересовался темой Consumer-Driven Contracts (CDC) и тестированием контрактов. В своём текущем проекте начал пробовать использовать [Pact](https://pact.io/) (и уже выявил несколько багов).

![](/assets/img/blog/2026/2026-04-04-consumer-driven-contracts.png)

И вот недавно попалась интересная подборка ссылок на эту тему. Скажу честно, что мне не удалось посмотреть всё из нижеперечисленного, но зато я актуализировал ссылки [оригинальной подборки](https://gist.github.com/michaellihs/e302a4a8450ca28cbd51f56968157e45). Решил оставить у себя на странице, чтобы никуда не пропало.
